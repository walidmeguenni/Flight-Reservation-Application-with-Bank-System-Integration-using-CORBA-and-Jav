...
/**
* AirLineCorba/VolHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Airline.idl
* Thursday, December 22, 2022 12:35:23 PM CET
*/

abstract public class VolHelper
{
  private static String  _id = "IDL:AirLineCorba/Vol:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[5] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (AirLineCorba.VolHelper.id (), "Vol", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    AirLineCorba.Vol value = new AirLineCorba.Vol ();
